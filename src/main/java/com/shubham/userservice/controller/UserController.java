...
import com.shubham.userservice.dto.SetUserRoleRequestDto;
...
public class UserController {
    ...
    public ResponseEntity<UserDto> setUserRoles(@PathVariable("id") Long userId, @RequestBody SetUserRoleRequestDto requestDto){
